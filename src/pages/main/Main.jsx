    ...
    <>
      <div className="section-2-main">
        <p>
          ...
          streamlined by several regional and national organization.The aim of
          the club is to seek and sensitize students to the importance of
          science and space research in the society, with Vayuvyastra the
          students can develop critical and creative thinking. Moreover, it
